...
- [x] 1.2 Add `VAULT_GIT_STAMP` config (default enabled); accessor `stamp_enabled()` mirroring `is_enabled()` truthy parsing
...
- [x] 4.7 Worker: `VAULT_GIT_STAMP=false` → committed file byte-identical to what was written
